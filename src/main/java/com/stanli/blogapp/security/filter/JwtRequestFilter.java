package com.stanli.blogapp.security.filter;

import com.stanli.blogapp.service.serviceImplementation.PersonServiceImpl;
import com.stanli.blogapp.utils.JwtUtils;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JwtRequestFilter(PersonServiceImpl personService, JwtUtils jwtTokenUtils) {
